        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <p class="navbar-text text-primary">[section : inscription]</p>
                </div>
                    ...
                    <div class="well">
                        <form action="inscription.php" method="post" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="passwordconf" class="form-control" placeholder="Confirmez le mot de passe" id="passwordconf">
                            </div>
                            <hr>
